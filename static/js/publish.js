...
add.addEventListener("click" , (event)=>{
    ...
    // new_single_note.querySelector("#type").setAttribute("name" , "type" + number_of_notes);
    // new_single_note.querySelector("#title").setAttribute( "name" ,  "title" + number_of_notes);
    // new_single_note.querySelector("#subject").setAttribute( "name" , "subject" + number_of_notes);
    // new_single_note.querySelector("#about").setAttribute( "name" ,  "about" + number_of_notes);
    // new_single_note.querySelector("#file").setAttribute( "name" ,  "file" + number_of_notes);
    // new_single_note.querySelector("#selected_note_id").setAttribute( "name" ,  "note_id" + number_of_notes);
